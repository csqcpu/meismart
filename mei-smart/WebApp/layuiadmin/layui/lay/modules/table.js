...
;layui.define(["rest","laytpl", "laypage", "layer", "form", "util"], function(e) {
    "use strict";
    var t = layui.$
      , rest =  layui.rest
      , i = layui.laytpl
    ...
    F.prototype.pullData = function(e) {
        ...
        a.url) {
            ...
            rest.ajax({
                ...
                headers: a.headers || {},
                success: function(t) {
                	//modified by csq_cpu 2019-4-29
                	if(t[n.statusName]==layui.setter.response.statusCode.logout){
                		parent.redirect()
                		return
                	}else if(t[n.statusName]==layui.setter.response.statusCode.perm){
                        i.layMain.html('<div class="' + h + '">权限限制：' + t[n.msgName] + "</div>"),
                        i.renderForm(),
                        i.setColsWidth()
                	}
                	//当前url用户权限{"select":"all","insert":"","update":"","delete":""}
